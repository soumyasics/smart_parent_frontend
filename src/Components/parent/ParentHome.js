      ...
      <div>
        <div className="parenthome_main">
          <div className="container">
            <h1 className="parent_home_heading">
              Real Solutions For <h1></h1>Everyday Parenting <h1></h1>{" "}
              Challenges
            </h1>
        ...
        <div className="parent_home_thirddiv">
          <h4>
            ...
            Smarter Parenting takes the techniques used by Behavioral
            Specialists and Mental Health Professionals and makes those same
