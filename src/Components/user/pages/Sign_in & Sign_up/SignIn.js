...
function SignIn() {
    ...
    const submitfn = (e) => {
        ...
        if (formValid) {
            ...
            axios.post("http://localhost:4009/smart_parent/loginParent", signin)
                .then((res) => {
            ...
            <div className='regformsignin'>
                ...
                <form onSubmit={submitfn}  >
                    ...
                    <div className="input-box signin-input" >
                        <div className='labelsignin'> <label>Email</label>  </div>
                    ...
                    <div className="input-box signin-input">
                        ...
                        <div className='labelsignin'> <label>Password</label>  </div>
                    ...
                    <div className="text1">
                        ...
                        <h5><Link to={"/reset_password"}>Reset Password</Link></h5>

                    </div>

                    <div className="text2">
                        <h5><Link to={"/sign_up"}>Signup</Link></h5>
                    </div>
